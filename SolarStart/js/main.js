...
//   console.log(panelsNeeded);
  ...
  let feedback = "";
  feedback += `<p>Based on your average daily use of ${Math.round(dailyUseKw)} Kwh, you will need to purchase ${panelsNeeded} ${panelName} brand solar panels to offset 100% of your electrical bill. </p>`;
  feedback += "<h2>Additional Details</h2>";
  feedback += `<p>Your average daily electricity consumption: ${Math.round(dailyUseKw)} Kwh per day.</p>`;
  feedback += `<p>Average sunshine house per day: ${sunHoursPerDay}  hours </p>`;
